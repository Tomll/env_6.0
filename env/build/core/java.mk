...
#Gionee: <Amigo_Framework> <lingfen> add for begin
    ifneq ($(LOCAL_AMIGOFRAMEWORK_RES),true)
        LOCAL_JAVA_LIBRARIES := amigoframework $(LOCAL_JAVA_LIBRARIES)
    endif
    ifneq ($(LOCAL_NO_YOUJUAGENT),true)
        LOCAL_JAVA_LIBRARIES := YouJuAgent $(LOCAL_JAVA_LIBRARIES)
    endif
#Gionee: <Amigo_Framework> <lingfen> add for end
  endif
endif
...
#Gionee <Amigo_Builder> lingfen modify it for proguard begin
#ifeq ($(filter obfuscation,$(LOCAL_PROGUARD_ENABLED)),)
# By default no obfuscation
#common_proguard_flags += -dontobfuscate
#endif  # No obfuscation
#Gionee <Amigo_Builder> lingfen modify it for proguard end
...
#Gionee <Amigo_ProguardMap> <lingfen> <2015-08-26> begin
	-$(ACP) -fp $(proguard_dictionary) $(GN_TARGET_OUT_ROOT_DIR)/proguard.map.1
#Gionee <Amigo_ProguardMap> <lingfen> <2015-08-26> end
