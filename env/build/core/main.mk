...
# Gionee lingfen modify it begin
#subdir_makefiles := \
	$(shell build/tools/findleaves.py --prune=$(OUT_DIR) --prune=.repo --prune=.git $(subdirs) Android.mk)

subdir_makefiles := \
	$(shell build/tools/findleaves.py --prune=$(OUT_DIR) --prune=.repo --prune=.git --prune=gn_project --prune=gionee --prune=release $(subdirs) Android.mk)
# Gionee lingfen modify it end
