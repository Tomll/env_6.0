...
#Gionee lingfen modify it for target install dir  beign
...
GN_TARGET_OUT_ROOT_DIR := $(GN_BUILD_TARGET_OUT_ROOT)
TARGET_OUT_EXECUTABLES := $(GN_TARGET_OUT_ROOT_DIR)/bin
TARGET_OUT_OPTIONAL_EXECUTABLES := $(GN_TARGET_OUT_ROOT_DIR)/xbin
TARGET_OUT_JAVA_LIBRARIES := $(GN_TARGET_OUT_ROOT_DIR)
TARGET_OUT_APPS := $(GN_TARGET_OUT_ROOT_DIR)
TARGET_OUT_APPS_PRIVILEGED := $(GN_TARGET_OUT_ROOT_DIR)
TARGET_OUT_ETC := $(GN_TARGET_OUT_ROOT_DIR)/etc
#Gionee lingfen modify it for target install dir end
