...
ifdef GN_APK_COPY_RESOURCES
	$(TRANSAGE_BUILD_CODE_DIR)/../copy_resources.sh $(R_file_stamp)
endif
...
#Gionee <Amigo_builder> <lingfen> add begin
$(call intermediates-dir-for,APPS,amigoframework-res,,COMMON)/package-export.apk :$(call intermediates-dir-for,APPS,framework-res,,COMMON)/src/R.stamp
#Gionee <Amigo_builder> <lingfen> add end
...
#Gionee <amigo_res> lingfen modify it begin
ifneq ($(LOCAL_AMIGOFRAMEWORK_RES), true)
framework_res_package_export += \
    $(call intermediates-dir-for,APPS,amigoframework-res,,COMMON)/package-export.apk
framework_res_package_export_deps += \
	$(call intermediates-dir-for,APPS,amigoframework-res,,COMMON)/src/R.stamp
endif
#Gionee <amigo_res> lingfen modify it end
